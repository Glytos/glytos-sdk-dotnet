    ...
    public sealed class Dnc
    {
        ...
        public Task<DncEntry> AddAsync(string phone, string? reason = null, CancellationToken cancellationToken = default) =>
            _client.RequestAsync<DncEntry>(
                HttpMethod.Post,
                "/dnc",
                new Dictionary<string, object?> { ["phone"] = phone, ["reason"] = reason },
        ...
        public Task<DncImportResult> ImportAsync(
            ...
            string? reason = null,
            CancellationToken cancellationToken = default) =>
            _client.RequestAsync<DncImportResult>(
                HttpMethod.Post,
                "/dnc/import",
                new Dictionary<string, object?> { ["phones"] = new List<string>(phones), ["reason"] = reason },
                cancellationToken: cancellationToken);
